...
(function ($) {
    ...
    var utils = {
        ...
        preload: function ($element, callback) {
            ...
            if (data.preload) {
                ...
                //	utils.logGroup.call(self,'loading');
        ...
        applyTransition: function (page, actions, variables) {
            ...
            utils.log.call(self, 'Totale azioni = ' + data.actionsNumber);
            //inserimento dell'HTML della pagina in un oggetto jQuery
            page = $('<div/>').append($.parseHTML(page));
            variables.page = page;

            var browserInfo = utils.getBrowserInfo();
            data.prefix = browserInfo.prefix;
        ...
        animation: {
            ...
            css3: {
                            ...
                            if (e.originalEvent.propertyName === handledElement.data('property') /*&& (parseInt(Math.round(e.originalEvent.elapsedTime*1000)) === andledElement.data('duration')*/) {
                                ...
                                if (value.params.changeContent) {
                                    ...
                                    if (relatedElement.length) {
                                        ...
                                        relatedElement.on(data.transitionHandler, function (e) {
                                            var handledElement = $(this);
                                            if (e.originalEvent.propertyName === handledElement.data('property') /*&& (parseInt(Math.round(e.originalEvent.elapsedTime*1000)) === andledElement.data('duration')*/) {
                                                //eliminazione dell'evento
                                                handledElement.off(data.transitionHandler);
                ...
                crossSlide: function (value, variables, animationData, key) {
                    ...
                    animationData.content.on(data.transitionHandler, function (e) {
                        var handledElement = $(this);
                        if (e.originalEvent.propertyName === handledElement.data('property') /*&& (parseInt(Math.round(e.originalEvent.elapsedTime*1000)) === andledElement.data('duration')*/) {
                            //eliminazione dell'evento
                            handledElement.off(data.transitionHandler);
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if (!me.data('AsyncNavigator')) {
                me.data('AsyncNavigator', {});
                firstLoad = true;
                if (History) {
            ...
            var data = me.data('AsyncNavigator');
            ...
            // rimozione overlay anti-click
            //di base il AsyncNavigator esclude i link che:
